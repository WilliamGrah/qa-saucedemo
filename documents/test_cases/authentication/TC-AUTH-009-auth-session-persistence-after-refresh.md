# Test Case: TC-AUTH-009 - Session Persistence After Refresh
...
6. Refresh the browser page (F5/Ctrl+R or ⌘+R)
7. Check if user is still logged in and on the inventory page

---

## Expected Result
- After refreshing, user should remain logged in
